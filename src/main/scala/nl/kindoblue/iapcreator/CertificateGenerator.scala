...
import org.bouncycastle.cert.jcajce.{JcaX509CertificateConverter, JcaCertStore, JcaX509ExtensionUtils, JcaX509v3CertificateBuilder}
...
/**
 * Here are gathered methods to generate keys, certificates,
 *
...
object CertificateGenerator {
   ...
   */
  def createSignedData(message : Array[Byte],
    ...
    val data = new CMSProcessableByteArray(message)
